...
MODEL_TYPE=ours_labse # e.g., ours_xlmr, labse, xlmr
HUMAN_TYPE=bert # `bert` for ours_labse, labse, and mbert. `xlmr` for xlmr
SAVE_PREF=../datastore/eval_retriever/$MODEL_TYPE
MODEL_PRETRAINED_DIR=../ckpts/ccpr_labse/ # remember to change the model dir
...
do
    ...
    --topk 1 \
    --human_indices_path ../eval_indices/data.$i.$HUMAN_TYPE.pt
